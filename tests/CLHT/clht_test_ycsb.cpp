...
#ifdef MACRO_TEST
// 1398101 * 3 = 4194303
#define N_BUCKETS 1398101
#define OPERATION_NUM 64000000
#else
// 349525 * 3 = 1048575
#define N_BUCKETS 349525
...
using persistent_map_type =
	nvobj::experimental::clht<string_t, string_t, string_hasher,
...
main(int argc, char *argv[])
{
	...
	std::ofstream ofs_throughput("clht_throughput.res");
...
#ifdef LATENCY_ENABLE
	std::ofstream ofs_latency("clht_latency.res");
